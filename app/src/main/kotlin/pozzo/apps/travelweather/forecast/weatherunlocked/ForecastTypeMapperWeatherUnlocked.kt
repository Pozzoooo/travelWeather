...
class ForecastTypeMapperWeatherUnlocked : ForecastTypeMapper {
    private val forecastTypeMap = mapOf(
            ...
            "occlightsleet.gif" to ForecastType.SCATTERED_THUNDERSTORMS,//todo sleet
            "modsleetswrsday.gif" to ForecastType.SCATTERED_THUNDERSTORMS,
            "modsleetswrsnight.gif" to ForecastType.SCATTERED_THUNDERSTORMS,
            "modsleet.gif" to ForecastType.SCATTERED_THUNDERSTORMS,
            "isosleetswrsnight.gif" to ForecastType.SCATTERED_THUNDERSTORMS,
            "isosleetswrsday.gif" to ForecastType.SCATTERED_THUNDERSTORMS,
            "heavysleetswrsnight.gif" to ForecastType.SCATTERED_THUNDERSTORMS,
            "heavysleetswrsday.gif" to ForecastType.SCATTERED_THUNDERSTORMS,
            "heavysleet.gif" to ForecastType.SCATTERED_THUNDERSTORMS,
